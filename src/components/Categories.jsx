function Categories() {
  return (
    <div className="flex container gap-8 flex-wrap   !mt-15 ">
      <button className=" flex-1 flex flex-col items-center justify-center gap-4 py-6 px-14 rounded hover:bg-blue-600 hover:text-white transition-all duration-300 border-2 border-gray-300 hover:border-blue-600 active:scale-95">
        <svg
          width="56"
          height="56"
          viewBox="0 0 56 56"
      ...
      <button className=" flex-1 flex flex-col items-center justify-center gap-4 py-6 px-14 rounded hover:bg-blue-600 hover:text-white transition-all duration-300 border-2 border-gray-300 hover:border-blue-600 active:scale-95">
        ...
        <span className="">SmartWatch</span>
      </button>
      <button className=" flex-1 flex flex-col items-center justify-center gap-4 py-6 px-14 rounded hover:bg-blue-600 hover:text-white transition-all duration-300 border-2 border-gray-300 hover:border-blue-600 active:scale-95">
        <svg
          width="56"
