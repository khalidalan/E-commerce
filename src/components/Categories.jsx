...
function Categories() {
  ...
  return (
    <div className="flex container gap-8 flex-wrap   !mt-5 ">
      <Link
        to="/category/phones"
        className=" flex-1 flex flex-col items-center justify-center gap-4 py-6     px-14 rounded hover:bg-blue-600 hover:text-white transition-all duration-300 border-2 border-gray-300 hover:border-blue-600 active:scale-95 "
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          ...
          >
            <g clipPath="url(#clip0_17079_868)">
              <path
            ...
            <defs>
              <clipPath id="clip0_17079_868">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.phones")}</span>
        </button>
      </Link>
      <Link
      ...
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          <svg
            ...
            className="transition-all duration-300"
          >
            <g clip-path="url(#clip0_17079_613)">
              <path
            ...
            <defs>
              <clipPath id="clip0_17079_613">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.computers")}</span>
        </button>
      </Link>
      ...
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          <svg
            ...
            className="transition-all duration-300"
          >
            <g clip-path="url(#clip0_17079_629)">
              <path
            ...
            <defs>
              <clipPath id="clip0_17079_629">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.smartWatch")}</span>
        </button>
      </Link>
      ...
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_17079_6">
                <rect width="56" height="56" fill="currentColor" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.camera")}</span>
        </button>
      </Link>
      ...
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          <svg
            ...
            className="transition-all duration-300"
          >
            <g clip-path="url(#clip0_17079_644)">
              <path
            ...
            <defs>
              <clipPath id="clip0_17079_644">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.headphones")}</span>
        </button>
      </Link>
      <Link
        to="/category/gaming"
      ...
      >
        <button className=" flex flex-col items-center justify-center gap-2">
          <svg
            ...
            className="transition-all duration-300"
          >
            <g clip-path="url(#clip0_17079_809)">
              <path
            ...
            <defs>
              <clipPath id="clip0_17079_809">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>

          <span className="">{t("categories.gaming")}</span>
        </button>
      </Link>
    </div>
  );
